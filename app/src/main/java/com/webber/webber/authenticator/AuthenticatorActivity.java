...
package com.webber.webber.authenticator;
...
import com.webber.webber.client.NetworkUtilities;
...
public class AuthenticatorActivity extends AccountAuthenticatorActivity {
    ...
    private void finishLogin(String authToken) {
        ...
        final Account account = new Account(mUsername, Constants.ACCOUNT_TYPE);
        Log.v(TAG, Constants.ACCOUNT_TYPE);
        if (mRequestNewAccount) {
            mAccountManager.addAccountExplicitly(account, mPassword, null);
            mAccountManager.setUserData(account, "uid", uid);
        ...
        Intent webberIntent = new Intent(this, WebberActivity.class);
        webberIntent.putExtra("uid", uid);
        PreferenceManager.setCurrentUID(this, uid);
        startActivity(webberIntent);
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... params) {
            ...
            try {
                WebberAccount wa = NetworkUtilities.authenticate(mUsername, mPassword);
                uid = wa.uid;
                return wa.authToken;
            } catch (Exception ex) {
